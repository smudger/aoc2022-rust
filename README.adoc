...
image::https://github.com/smudger/aoc2022-rust/actions/workflows/benchmark.yml/badge.svg[link="https://github.com/smudger/aoc2022-rust/actions/workflows/benchmark.yml", title="Benchmark"]
